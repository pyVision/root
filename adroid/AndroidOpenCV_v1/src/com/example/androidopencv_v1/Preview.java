...
public class Preview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    ProcessImage opencvp;
    
    Preview(Context context, DrawOnTop drawOnTop) {
        super(context);
        opencvp=new ProcessImage();
           ...
           mCamera.setPreviewCallback(new PreviewCallback() {
        	  public void onPreviewFrame(byte[] data, Camera camera)
        	  {
        		  ...
        		  if (mDrawOnTop.mBitmap == null)
        		  {
        			  ...
        			  Log.e("ZZ","pew size is "+mDrawOnTop.mImageWidth+":"+mDrawOnTop.mImageHeight);
        			  mDrawOnTop.mBitmap = Bitmap.createBitmap(mDrawOnTop.mImageWidth, mDrawOnTop.mImageHeight, Bitmap.Config.ARGB_8888);
